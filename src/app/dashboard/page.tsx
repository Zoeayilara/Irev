      ...
      <header className="border-b border-border bg-card">
        <div className="container mx-auto px-4 py-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <Link href="/profile" className="text-sm text-slate-700 hover:underline dark:text-slate-200">
              Profile
            </Link>
            {user.role === "ADMIN" && (
              <Link href="/admin" className="text-sm text-slate-700 hover:underline dark:text-slate-200">
                Admin
              </Link>
            )}
            <form action={logout}>
          ...
          <Card className="lg:col-span-2">
            ...
            <CardContent className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-md border border-border bg-muted p-4">
                ...
                <div className="mt-2">
                  {pendingAttempt ? <Badge variant="warning">Result Pending (24h)</Badge> : <Badge variant="success">Active</Badge>}
                </div>
              </div>
            </CardContent>
          </Card>
